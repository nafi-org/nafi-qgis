...
class UploadBurntAreas(QgsProcessingAlgorithm):
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterRasterLayer(
                ...
                "Rasterised and merged burnt area map",
                defaultValue=None,
            )
        )
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        feedback.pushInfo(f"Saving attributed burnt areas to {saveBurntAreas} …")
        ...
        feedback.pushInfo(f"Rasterised burnt areas path: {rasterisedBurntAreasPath}")
        ...
        archive = path.join(archiveLocation, f"bfnt_{region.lower()}_current_sr3577")
        ...
        return {"ArchiveLocation": archive}
