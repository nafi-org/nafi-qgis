...
class TestWorkingLayer(unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.assertTrue(
            Path(getWorkingDirectory()) in Path(workingLayer.shapefilePath).parents,
            "Working layer shapefile is not in working directory!",
        )
    ...
    def test_save(self):
        ...
        workingLayer.save()
        self.assertTrue(
            Path(workingLayer.shapefilePath).exists(),
