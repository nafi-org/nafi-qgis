...
class Ui_NafiAboutDialogBase(object):
    def setupUi(self, NafiAboutDialogBase):
        ...
        NafiAboutDialogBase.resize(1000, 1000)
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 990, 990))
