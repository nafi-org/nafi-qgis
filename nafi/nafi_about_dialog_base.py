...
class Ui_NafiAboutDialogBase(object):
    ...
    def retranslateUi(self, NafiAboutDialogBase):
        ...
        self.iconLabel.setText(_translate("NafiAboutDialogBase", "<html><head/><body><p><img src=\":/plugins/nafi/icon.png\"/></p></body></html>"))
        ...
        self.firescarLabel.setText(_translate("NafiAboutDialogBase", "<html><head/><body><p><img src=\":/plugins/nafi/firescar.jpg\"/></p></body></html>"))
