...
/***************************************************************************
 Ntrrp
                                 A QGIS plugin
 NAFI Burnt Areas Mapping tools
...
class Ntrrp:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&NT Risk Reduction Program')
        self.toolbar = self.iface.addToolBar(u'NT Risk Reduction Program')
        self.toolbar.setObjectName(u'NT Risk Reduction Program')
    ...
    def initGui(self):
        ...
        self.addAction(
            icon_path,
            text=self.tr(u'NT Risk Reduction Program'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&NT Risk Reduction Program'),
                action)
