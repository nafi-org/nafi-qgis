...
class Ui_NtrrpAboutDialogBase(object):
    ...
    def retranslateUi(self, NtrrpAboutDialogBase):
        ...
        self.iconLabel.setText(_translate(
            "NtrrpAboutDialogBase", "<html><head/><body><p><img src=\":/plugins/ntrrp/images/icon.png\"/></p></body></html>"))
        ...
        self.firescarLabel.setText(_translate(
            "NtrrpAboutDialogBase", "<html><head/><body><p><img src=\":/plugins/ntrrp/images/firescar.jpg\"/></p></body></html>"))
