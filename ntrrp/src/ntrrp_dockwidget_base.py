...
class Ui_NtrrpDockWidgetBase(object):
    def setupUi(self, NtrrpDockWidgetBase):
        ...
        self.gridLayout.addWidget(self.currentMappingButton, 2, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.createButton, 2, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.approveButton, 2, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.uploadButton, 2, 8, 1, 1)
        self.sourceLayerComboBox = QtWidgets.QComboBox(self.dockWidgetContents)
        self.sourceLayerComboBox.setObjectName("sourceLayerComboBox")
        self.gridLayout.addWidget(self.sourceLayerComboBox, 3, 2, 1, 6)
