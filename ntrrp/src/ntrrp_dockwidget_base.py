...
class Ui_NtrrpDockWidgetBase(object):
    def setupUi(self, NtrrpDockWidgetBase):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/plugins/ntrrp/images/approve.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.approveButton.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/plugins/ntrrp/images/upload.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.uploadButton.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.gridLayout.addWidget(self.workingLayerComboBox, 4, 3, 1, 5)
    ...
    def retranslateUi(self, NtrrpDockWidgetBase):
        ...
        self.uploadButton.setText(_translate("NtrrpDockWidgetBase", "<html><head/><body><p><span style=\"font-weight:600;\">Source layer</span></p></body></html>"))
