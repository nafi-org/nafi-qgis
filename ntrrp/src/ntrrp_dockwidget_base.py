...
class Ui_NtrrpDockWidgetBase(object):
    def setupUi(self, NtrrpDockWidgetBase):
        ...
        self.activeSourceLayerLabel.setAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
    ...
    def retranslateUi(self, NtrrpDockWidgetBase):
        ...
        self.downloadButton.setToolTip(_translate("NtrrpDockWidgetBase", "Download NAFI Segmentation Features"))
        ...
        self.sourceLayerLabel.setText(_translate("NtrrpDockWidgetBase", "<html><head/><body><p><span style=\" font-weight:600;\">Segmentation layer</span></p></body></html>"))
