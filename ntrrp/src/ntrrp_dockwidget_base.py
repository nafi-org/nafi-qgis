...
class Ui_NtrrpDockWidgetBase(object):
    def setupUi(self, NtrrpDockWidgetBase):
        ...
        self.mappingComboBox = QtWidgets.QComboBox(self.dockWidgetContents)
        self.mappingComboBox.setObjectName("mappingComboBox")
        self.gridLayout.addWidget(self.mappingComboBox, 0, 2, 1, 6)
